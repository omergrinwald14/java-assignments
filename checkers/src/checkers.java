...
public class checkers {
    ...
    public static boolean computer_turn(String[][] check_board) {
        ...
        int i_double = 0;
        int j_double = 0;
        //chek if there is any white who can eat
        ...
        if(!flag) {//nothing to eat do a random move
            ...
            int[] computer_tools = new int[12];//calc how many tools left in the game
            int count = 0;
            for (int i = 0; i < 7; i++)
                for (int j = 0; j < 7; j++) {
                    if (check_board[i][j].equals("W")) {
    ...
    public static void is_food_queen_computer(int i, int j, String[][] check_board, String direction) {//original input . text the 2 for loop on rows and col


        if (check_board[i][j].equals("Q-W") && direction.equals("right-forward"))//move right
        {
    ...
    public  static void   eat_queen_computer ( int eat_i, int eat_j, String[][] check_board,int des_i,int des_j )
    {
        check_board[eat_i][eat_j]="*";
        check_board[des_i][des_j]="Q-W";
...
return  false;
    ...
    public  static void    eat_queen_player ( int eat_i, int eat_j, String[][] check_board,int des_i,int des_j )
    {
        check_board[eat_i][eat_j]="*";
